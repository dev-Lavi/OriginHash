...
const AdminLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      const res = await axios.post("https://originhash.onrender.com/api/v1/admin/login", payload);
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#6C4CFF]/50 to-[#edeef7]/60 p-4 relative">
      ...
      <div className="bg-white rounded-3xl shadow-xl w-full max-w-5xl grid md:grid-cols-2 overflow-hidden relative z-10" style={{ minHeight: "600px" }}>
        ...
        <div className="flex flex-col justify-center p-10">
          ...
          <p className="text-center text-gray-500 mb-6">Enter your credentials to access admin dashboard</p>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={loading || (lockoutTime && Date.now() < lockoutTime) || wrongAttempts >= 5}
